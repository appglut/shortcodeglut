<?php
/**
 * Card: Horizontal Cyan Template
 * Template for rendering WooCommerce products in horizontal layout with cyan accent
...
global $product;
?>
<div class="product-design product-card-horizontal-cyan" data-product-id="[product_id]">
