<?php
/**
 * Card: Horizontal Blue Template
 * Template for rendering WooCommerce products in horizontal layout with blue accent
 * Now using conditional template tags instead of PHP
 */
...
global $product;
?>
<div class="product-design product-card-horizontal-blue" data-product-id="[product_id]">
    <div class="cta-container">
        <div class="product-item">
            <div class="product-thumb">
                <a href="[product_permalink]">
                    <div class="pri-img" style="background-image: url('[product_image_url_800x600]');"></div>
                </a>
            ...
            <div class="product-caption product-identity">
                ...
                [has_categories: <span class="product-category">
                    [product_categories]
                </span> ]
