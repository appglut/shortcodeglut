<?php
/**
 * Product Card: tropical Template
 * Template for rendering WooCommerce products in tropical theme
...
global $product;
?>
<div class="shortcodeglut-product-cards shortcodeglut-template-product-card-tropical" data-product-id="[product_id]">
    <div class="product-template14">
