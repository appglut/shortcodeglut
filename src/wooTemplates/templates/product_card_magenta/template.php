...
global $product;
?>
<div class="shortcodeglut-product-cards shortcodeglut-template-product-card-magenta" data-product-id="[product_id]">
    <div class="product-template15">
