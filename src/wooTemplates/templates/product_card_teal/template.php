<?php
/**
 * Product Card: teal Template
 * Template for rendering WooCommerce products in teal theme
...
global $product;
?>
<div class="shortcodeglut-product-cards shortcodeglut-template-product-card-teal" data-product-id="[product_id]">
    <div class="product-template12">
