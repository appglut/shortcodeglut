...
global $product;
?>
<div class="shortcodeglut-product-cards shortcodeglut-template-product-card-lime" data-product-id="[product_id]">
    <div class="product-template13">
