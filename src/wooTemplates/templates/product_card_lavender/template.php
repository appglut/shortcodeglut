<?php
/**
 * Product Card: lavender Template
...
global $product;
?>
<div class="shortcodeglut-product-cards shortcodeglut-template-product-card-lavender" data-product-id="[product_id]">
    <div class="product-template18">
