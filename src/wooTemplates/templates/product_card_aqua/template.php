<?php
/**
 * Product Card: aqua Template
 * Template for rendering WooCommerce products in aqua theme
...
global $product;
?>
<div class="shortcodeglut-product-cards shortcodeglut-template-product-card-aqua" data-product-id="[product_id]">
    <div class="product-template17">
