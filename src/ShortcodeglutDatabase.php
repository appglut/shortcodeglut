...
class ShortcodeglutDatabase {
	...
	public static function table_showcase_filters() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_enhancement_filters';
	}

	public static function table_user_actions() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_user_actions';
	}

	public static function table_shop_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_shop_layouts';
	}

	public static function table_archive_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_archive_layouts';
	}

	public static function table_shopg_wishlist() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_wishlist';
	}

	public static function table_single_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_single_product_layout';
	}

	public static function table_cartpage_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_cartpage_layouts';
	}

	public static function table_ordercomplete_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_ordercomplete_layouts';
	}

	public static function table_accountpage_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_accountpage_layouts';
	}

	public static function table_shortcodes_showcase() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_shortcodes_showcase';
	}

	public static function table_gallery_shortcode() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_gallery_shortcode';
	}

	public static function table_tabs_showcase() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_tabs_showcase';
	}

	public static function table_badges_showcase() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_badges_showcase';
	}
    
	public static function table_banners_showcase() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_banners_showcase';
	}

	public static function table_shop_banner_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_shopbanner_layouts';
	}

	public static function table_slider_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_slider_layouts';
	}

	public static function table_tab_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_tab_layouts';
	}

	public static function table_accordion_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_accordion_layouts';
	}

	public static function table_gallery_layouts() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_gallery_layouts';
	}

	public static function table_mega_menu_showcase() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_mega_menus';
	}

	public static function table_quickview_enhancement() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_quickview_layouts';
	}

	public static function table_comparison_enhancement() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_comparison_layouts';
	}

	public static function table_lock_settings() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_lock_settings';
	}

	public static function table_woo_templates() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_woo_templates';
	}

	public static function table_product_custom_field_settings() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_product_custom_field_settings';
	}

	public static function table_product_badges() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_product_badge_layouts';
	}

	public static function table_product_swatches() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_productswatches_layout';
	}


	public static function table_showcase_filters1() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_enhancements_filters';
	}
	...
	private static function table_exists( $table_name ) {
		...
		// Check cache first
		$cache_key = 'shortcodeglut_table_exists_' . md5( $table_name );
		$cached_result = wp_cache_get( $cache_key, 'shortcodeglut_db_schema' );
		...
		wp_cache_set( $cache_key, $exists, 'shortcodeglut_db_schema', HOUR_IN_SECONDS );
	...
	private static function column_exists( $table_name, $column_name ) {
		...
		// Check cache first
		$cache_key = 'shortcodeglut_column_exists_' . md5( $table_name . '_' . $column_name );
		$cached_result = wp_cache_get( $cache_key, 'shortcodeglut_db_schema' );
	...
	public static function create_gallery_shortcode() {
		...
		if (class_exists('\Shortcodeglut\galleryShortcode\GalleryDataTables')) {
			\Shortcodeglut\galleryShortcode\GalleryDataTables::create_tables();
		}
	}
	...
	public static function create_wishlist_table() {
			...
			wp_cache_delete( 'shortcodeglut_table_exists_' . md5( $table_name ) );
    }
	...
	public static function shortcodeglut_woo_subscription_table() {
		global $wpdb;
		$charset_collate = $wpdb->get_charset_collate();
		...
		// Subscription Tables
		$sql[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}shortcodeglut_woo_subscriptions (
		...
		$sql[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}shortcodeglut_subscription_items (
		...
		$sql[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}shortcodeglut_subscription_meta (
		...
		$sql[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}shortcodeglut_subscription_schedule (
	...
	public static function shortcodeglut_create_slider_table() {
		global $wpdb;
		$table_name = $wpdb->prefix . 'shortcodeglut_sliders';
		$charset_collate = $wpdb->get_charset_collate();
	...
	public static function shortcodeglut_create_tab_table() {
		global $wpdb;
		$table_name = $wpdb->prefix . 'shortcodeglut_tabs';
		$charset_collate = $wpdb->get_charset_collate();
	...
	public static function shortcodeglut_create_accordion_table() {
		global $wpdb;
		$table_name = $wpdb->prefix . 'shortcodeglut_accordions';
		$charset_collate = $wpdb->get_charset_collate();
	...
	public static function shortcodeglut_create_gallery_table() {
		global $wpdb;
		$table_name = $wpdb->prefix . 'shortcodeglut_gallerys';
		$charset_collate = $wpdb->get_charset_collate();
	...
	public static function create_woo_templates() {
		...
		// Add template_css column if it doesn't exist
		if ( $was_existing && ! self::column_exists( $table_name, 'template_css' ) ) {
			// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.SchemaChange,WordPress.DB.DirectDatabaseQuery.NoCaching,WordPress.DB.PreparedSQL.InterpolatedNotPrepared,PluginCheck.Security.DirectDB.UnescapedDBParameter -- ALTER TABLE for adding column to existing table, safe table name from internal function
			$wpdb->query( "ALTER TABLE {$table_name} ADD COLUMN template_css longtext AFTER template_tags" );
			$added_column = true;
		}
		...
		if ( self::table_exists( $table_name ) && ! $added_column ) {
			...
			if ( $count == 0 ) {
				...
				\Shortcodeglut\wooTemplates\WooTemplatesEntity::insertDefaultTemplates();
			}
			return;
		}
	...
	public static function table_product_comparisons() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_product_comparisons';
	}
	...
	public static function table_product_quickview() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_product_quickview';
	}

	// Add this function to define the table name
	public static function table_checkout_fields() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_checkout_fields';
	}
	...
	public static function table_checkout_field_values() {
		global $wpdb;
		return $wpdb->prefix . 'shortcodeglut_checkout_field_values';
	}
